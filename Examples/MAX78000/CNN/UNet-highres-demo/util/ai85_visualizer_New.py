...
#send_image_receive_output(ser, folded_img, output_filename)  # send image and receive inference
send_image_receive_output(ser, None, output_filename)  # only receive inference, image is captured by evkit
